...
# coding: utf-8
"""
This script was developed to parallel process preformatted time series of input
data needed for the Kljun et. al 2d flux footprint prediction code and
ultimately create monthly-ETo-weighted footprint georeferenced footprint
rasters. 
...
using OpenDAP given Earthdata login info. Only months with 20 days worth of
good hourly data are used, specifically the criteria 13*20 = 260 or more hours
of data (only from hours between 6:00AM to 8:00 PM) must exist in a month.
Checks are performed to ensure final weighting procedure was successful at
